...
class SOSGameTest {
  ...
  void testBoardSize(){
    ...
    //AC 1.1
    SOSGame Game1 = new SOSGame(5,0, false, SOSGame.PlayerType.HUMAN, SOSGame.PlayerType.HUMAN);
    assertEquals(5, Game1.getBoardSize());

    //AC 1.2
    SOSGame Game2 = new SOSGame(-5,0, false, SOSGame.PlayerType.HUMAN, SOSGame.PlayerType.HUMAN);
    assertEquals(3, Game2.getBoardSize());

    //AC 1.3
    SOSGame Game3 = new SOSGame(5.5,0, false, SOSGame.PlayerType.HUMAN, SOSGame.PlayerType.HUMAN);
    assertEquals(5, Game3.getBoardSize());

    //AC 1.4
    SOSGame Game4 = new SOSGame(50,0, false, SOSGame.PlayerType.HUMAN, SOSGame.PlayerType.HUMAN);
    assertEquals(10, Game4.getBoardSize());

    //AC 1.5
    SOSGame Game5 = new SOSGame('z',0, false, SOSGame.PlayerType.HUMAN, SOSGame.PlayerType.HUMAN);
  ...
  void testGameModeSelection(){
    //AC 2.1
    SOSGame Game1 = new SOSGame(3,0, false, SOSGame.PlayerType.HUMAN, SOSGame.PlayerType.HUMAN);
    assertEquals("Simple", Game1.getGameMode());

    //AC 2.2
    SOSGame Game2 = new SOSGame(3,1, false, SOSGame.PlayerType.HUMAN, SOSGame.PlayerType.HUMAN);
    assertEquals("General", Game2.getGameMode());
  }

  @Test
  void testGameStart(){
    SOSGame Game = new SOSGame(3,0, false, SOSGame.PlayerType.HUMAN, SOSGame.PlayerType.HUMAN);
  ...
  @Test
  void testPlayerMove(){
    SOSGame Game = new SOSGame(0,3, false, SOSGame.PlayerType.HUMAN, SOSGame.PlayerType.HUMAN);
  ...
  void testGetGeneralGameScore(){
    SOSGame Game = new SOSGame(3,1, false, SOSGame.PlayerType.HUMAN, SOSGame.PlayerType.HUMAN);
    ...
    //AC 6.4
    //Player 2 scoring
    Game.resetGame(3,1, false, SOSGame.PlayerType.HUMAN, SOSGame.PlayerType.HUMAN);
  ...
  void testPlayerTypeSelection(){
    ...
    Game.resetGame(3,0,false,SOSGame.PlayerType.COMPUTER,SOSGame.PlayerType.HUMAN);
    assertEquals(SOSGame.PlayerType.COMPUTER, Game.getPlayerType(SOSGame.Turn.PL1));
    assertEquals(SOSGame.PlayerType.HUMAN, Game.getPlayerType(SOSGame.Turn.PL2));

    Game.resetGame(3,0,false,SOSGame.PlayerType.HUMAN,SOSGame.PlayerType.COMPUTER);
    assertEquals(SOSGame.PlayerType.HUMAN, Game.getPlayerType(SOSGame.Turn.PL1));
    assertEquals(SOSGame.PlayerType.COMPUTER, Game.getPlayerType(SOSGame.Turn.PL2));

    Game.resetGame(3,0,false,SOSGame.PlayerType.COMPUTER,SOSGame.PlayerType.COMPUTER);
    assertEquals(SOSGame.PlayerType.COMPUTER, Game.getPlayerType(SOSGame.Turn.PL1));
    assertEquals(SOSGame.PlayerType.COMPUTER, Game.getPlayerType(SOSGame.Turn.PL2));
  }
  ...
  void testComputerPlayer2Simple(){
    ...
    SOSGame Game = new SOSGame(3,0,false,SOSGame.PlayerType.HUMAN,SOSGame.PlayerType.COMPUTER);
  ...
  void testComputerPlayer2General(){
    SOSGame Game = new SOSGame(3,1,false,SOSGame.PlayerType.HUMAN,SOSGame.PlayerType.COMPUTER);
  ...
  void testComputerPlayer1Simple(){
    SOSGame Game = new SOSGame(3,0,false,SOSGame.PlayerType.COMPUTER,SOSGame.PlayerType.HUMAN);
  ...
  void testComputerPlayer1General(){
    SOSGame Game = new SOSGame(3,1,false,SOSGame.PlayerType.COMPUTER,SOSGame.PlayerType.HUMAN);
